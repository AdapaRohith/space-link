...
import {
  Users, PhoneForwarded, TrendingUp,
...
const DonutChart = memo(function DonutChart({ data, size = 180, onSelect }) {
...
export default function Dashboard() {
  const [stats, setStats] = useState({ total: 0, followUpsDue: 0, newToday: 0, byStatus: {}, bySource: {}, byAssignee: {} });
  ...
  useEffect(() => {
    async function load() {
      try {
        ...
        const [users, statsData, todayLeads, acts, srcs] = await Promise.all([
          getAllUsers(),
          getLeadStats(),
          getTodayLeads(),
